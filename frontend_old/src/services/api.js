...
const getBaseUrl = () => {
    ...
    // 2. Prioritize environment variable (for manual overrides)
    const envUrl = import.meta.env.VITE_API_URL;
    if (envUrl) return envUrl;

    // 3. VPS/Cloud Auto-Detection: Use the current hosting domain
    // If we are on https://vps-domain.com, the backend is likely there too.
