...
from services.planet_nakshatra_backtest_service import planet_nakshatra_backtest_service
...
def backtest_planet_nakshatra(
    ...
    try:
        ...
        result = planet_nakshatra_backtest_service.run(
            smart_api=smart_api,
            years=years,
            # Planets requested by user: Sun/Mars/Jupiter/Saturn/Mercury/Rahu/Ketu
            planets=["Sun", "Mars", "Jupiter", "Saturn", "Mercury", "Rahu", "Ketu"],
            # Events
